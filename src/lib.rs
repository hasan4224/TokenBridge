...
#[derive(Debug)]
pub struct TokenBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TokenBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TokenBridge processing");
    
    let mut processor = TokenBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TokenBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TokenBridgeProcessor::new(false);
